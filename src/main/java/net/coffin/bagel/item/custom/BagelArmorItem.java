...
public class BagelArmorItem extends ArmorItem {
    private static final Map<RegistryEntry<ArmorMaterial>, List<StatusEffectInstance>> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<RegistryEntry<ArmorMaterial>, List<StatusEffectInstance>>())
                    .put(ModArmorMaterials.BAGEL_ARMOR,
                            List.of(new StatusEffectInstance(StatusEffects.REGENERATION, 20 * 3, 0, false, false))).build();

    public BagelArmorItem(RegistryEntry<ArmorMaterial> material, Type type, Settings settings) {
